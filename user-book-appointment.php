...
<div class="container d-flex justify-content-center">
    <div class="row my-5">
        ...
        <div class="col-md-6 rcol">
            <form class="sign-up" method="post" action="action.php">

                <h2 class="heading mb-4">Sign up</h2>    

                <div class="form-group fone mt-2"> <i class="fa fa-user"></i> <input type="name" class="form-control" placeholder="Name" name="name" id="name"> </div>

                <?php
                    $date= $_POST['date'];
                    $query = mysqli_query($con, "select * from time_slots where slot NOT IN (Select time from appointment where date='$date')");
                    if($query)
                    {
                       echo "<select name='time'>
                            ...
                            {
                                echo "<option value='".$var['slot']."'>".$var['slot']."</option>";
                            }
                        }
                ?>
                ...
                <button type="submit" class="btn btn-success mt-5" name="book-appointment" id="book-appointment">Book Appointment</button>
